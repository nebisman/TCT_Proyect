...
new_process.add_transition(M1, [(0, 1), (1, 2), (2, 3), (3, 0)], ['M1_ON', 'M1_Bussy', 'M1_OFF', 'M1_END'],
...
new_process.add_transition(Buffer_alimentar, [(0, 1), (1, 2), (2, 3), (3, 0)],
                           ['BA_ON', 'fed', 'BA_OFF', 'M1_END'], ['fed', 'M1_END'])

start = new_process.new_automaton('start')
new_process.add_state(start, 2, ["waiting", 'start'], [True, True])
new_process.add_transition(start, [(0, 1), (1, 1)], ['start', 'BA_ON'], ['start'])
...
new_process.add_transition(REQ_M1, [(0, 1), (1, 0)], ['11', 'Piece_located'], ['Piece_located'])
REQ_M2 = new_process.new_automaton('REQ_M2')
new_process.add_state(REQ_M2, 2, [], [True, False, ])
new_process.add_transition(REQ_M2, [(0, 1), (1, 0)], ['21', 'M2_END'], ['M2_END'])
...
new_process.generate_ST_OPENPLC([sup],
                                [plant],
                                actuators, '2M1B', Mask=Mascaras, Aislated=AISLATED)

...
actuators['M1_BROKEN'] = 'GD_IN_10:OFF:%IX100.10' #12
actuators['M2_BROKEN'] = 'GD_IN_11:OFF:%IX100.11' #22
actuators['M1_REPAIR'] = 'GD_IN_12:ON:%IX100.12'
actuators['M2_REPAIR'] = 'GD_IN_13:ON:%IX100.13'
...
actuators['M1_REPAIR_OUT_ON'] = 'GD_OUT_12:ON:%QX100.12'
actuators['M2_REPAIR_OUT_ON'] = 'GD_OUT_13:ON:%QX100.13'
actuators['M1_REPAIR_OUT_OFF'] = 'GD_OUT_12:OFF:%QX100.12'
actuators['M2_REPAIR_OUT_OFF'] = 'GD_OUT_13:OFF:%QX100.13'
...
Mascaras['NOT GD_IN_10'] = [('GD_OUT_10', '%QX100.10')]  # M1_BROKEN -> M1_BROKEN
Mascaras['NOT GD_IN_11'] = [('GD_OUT_11', '%QX100.11')]  # M2_BROKEN -> M2_BROKEN
...
new_process.generate_ST_OPENPLC([sup],
                                [plant],
                                actuators, '2M1B_R', Mascaras=Mascaras, Aislados=AISLATED)

...
void BLANK_PROJECT_init__(BLANK_PROJECT *data__, BOOL retain) {
  __INIT_VAR(data__->DUMMY_IN,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->DUMMY_OUT,__BOOL_LITERAL(FALSE),retain)
}
...
void BLANK_PROJECT_body__(BLANK_PROJECT *data__) {
  ...
  __SET_VAR(data__->,DUMMY_OUT,,__GET_VAR(data__->DUMMY_IN,));

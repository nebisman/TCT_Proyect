...
new_process.add_transition(Banda_M1, [(0, 1), (1, 0)], ['M1_BAND_ON', 'M1_BAND_OFF'], ['M1_BAND_ON'])
...
new_process.add_transition(Clamp_REQ, [(0, 1), (1, 2), (2, 0)], ["Clamp_on", "Clamped", "Clamp_off"], ['Clamped'])
...
new_process.add_transition(Banda_TU, [(0, 1), (1, 0)], ['TU_BAND_ON', 'TU_BAND_OFF'], ['TU_BAND_ON'])
...
new_process.add_transition(TU_Function, [(0, 1), (1, 2),
                           ...
                           ['TU_BAND_ON', 'Piece_at_review',  # Piece_at_TU ->5
                            ...
                            'Piece_wrong', 'TU_ARM_ON', 'Piece_at_PyP', 'TU_ARM_OFF', 'TU_BAND_OFF'],
                           ['TU_BAND_ON', 'Piece_at_review', 'Piece_right', 'Piece_out', 'Piece_at_PyP',
                            'Piece_wrong'])
...
new_process.add_transition(B1SP, [(0, 1), (0, 1), (1, 0)], ['2', 'Piece_reprocessed', '3'], ['2', 'Piece_reprocessed'])
...
new_process.add_transition(start, [(0, 1), (1, 1), (1, 1), (1, 1)], ['start', '1', '3', '5'], ['start'])
